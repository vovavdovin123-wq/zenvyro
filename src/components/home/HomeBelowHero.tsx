...
import { processSteps, services, team } from "@/content/site";
              ...
              <div className="zn-bento-visual">
                <div className="zn-stat">
                  <p className="zn-stat-num">
                    <CountUp value={processSteps.length} />
                  </p>
      ...
      <section className="zn-sec zn-sec--alt">
        <div className="zn-inner zn-qs">
          <FadeIn>
            ...
            <p className="zn-lead">{processSteps.length} этапов. Новый запрос — отдельный этап, текущий не раздуваем.</p>
          ...
          <div className="zn-glass zn-board">
            <div className="zn-board-bar">
              <span>заказ</span>
              <span>{processSteps.length} этапов</span>
            </div>
            <ol>
